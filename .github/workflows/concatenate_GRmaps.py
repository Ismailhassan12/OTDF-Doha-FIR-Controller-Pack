...
def main():
    ...
    targets = [
        ('Maps', 'OTDF/Plugins/Ground Radar Plugin/GRpluginMaps.txt', ['regions.txt', 'geo.txt', 'freetext.txt', 'nets.txt'], add_colours_and_definitions),
        ('Stands', 'OTDF/Plugins/Ground Radar Plugin/GRpluginStands.txt', ['stands.txt'], add_stand_groups),
    ]
